...
const displayWord = (word) => {
  ...
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.top-word h3').append(`"${topWord}" = ${topWordCount} times`);
}

const sendWords = () => {
  const words = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.text-submission textarea').val();
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.text-submission button').on('click', sendWords);
})
